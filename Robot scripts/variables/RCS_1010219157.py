...
LOCALHOST=	"10.10.219.47"

#############################################################################
#IP'S
#############################################################################
MSTORE_IP=								"10.10.219.157"
MSTORE_CASSANDRA_IP=					"10.10.227.42"
PNS_SERVER=                             "10.10.219.47"
NMS_SERVER=                             "10.10.219.47"
...
MSTORE_CASSANDRA_KEYSPACE=             "phn2o_schema"
PNS_SERVICE_PORT=						6162
...
#############################################################################
PATH_TO_STORE_LOGS_PCAPS=               "/root/saurav/automation/"+str(EPOCHTIME)+"/"

OEM_SERVER_ROOT_PATH=					"10.10.227.12:83/phone20/mStoreRelay.path=http://10.10.219.157:80"
...
REST_PROVISION_URI=						"host/nms/v1/vms/provision"
...
#X-MSTOREFE-ADDRESS
FE_NAME=                                "mStoreSaurav"
NODE_ID=                                0
SLOT_ID=                                1
SHELF_ID=                               1
LOCAL_FQDN=                             "10.10.219.157"
...
IMDN_MESSAGE_ID=						"75114622-099d-4503-8166-e84bd1b620dc"
CORRELATION_ID=							IMDN_MESSAGE_ID
MSG_DEPOSITTIME_EPOCH=					int(time.time())
X_IMDN_CORRELATOR=						str(FROM_MSISDN)+"_"+str(CONVERSATION_ID)+"_"+str(IMDN_MESSAGE_ID)
