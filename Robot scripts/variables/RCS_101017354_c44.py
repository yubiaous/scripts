...
MSTORE_CASSANDRA_KEYSPACE=             "c44_digits_schema"
PNS_SERVICE_PORT=						8345
PNS_SERVER_NAME=						"pns.server.mavenir1.com"
#PNS_SERVER_NAME=						"10.10.224.173"
NMS_SERVICE_PORT=						6083
...
''.join(random.choice(randomchoice) for i in range(8))

FROM_MSISDN=                            "9999999990"
TO_MSISDN=                              "8888888880"
TO_MSISDN1=								"1777777777"
TO_MSISDN2=								"2666666666"
TO_MSISDN3=								"3555555555"
TO_MSISDN4=								"4444444444"
TO_MSISDN5=								"5333333333"

randomnum="0123456789"
FROM_MSISDN=''.join(random.choice(randomnum) for i in range(10)) 
TO_MSISDN=''.join(random.choice(randomnum) for i in range(10))    
#TO_MSISDN1=''.join(random.choice(randomnum) for i in range(10))    
#TO_MSISDN2=''.join(random.choice(randomnum) for i in range(10))    
#TO_MSISDN3=''.join(random.choice(randomnum) for i in range(10))    
#TO_MSISDN4=''.join(random.choice(randomnum) for i in range(10))    
#TO_MSISDN5=''.join(random.choice(randomnum) for i in range(10))    
...
#MSG_TO=                                 "sip:"+str(TO_MSISDN)+"@lab.t-mobile.com"
...
str1= ''.join(random.choice(randomchoice) for i in range(8))
str2= ''.join(random.choice(randomchoice) for i in range(4))
str3= ''.join(random.choice(randomchoice) for i in range(4))
str4= ''.join(random.choice(randomchoice) for i in range(4))
str5= ''.join(random.choice(randomchoice) for i in range(12))
result_str=	str(str1)+"-"+str(str2)+"-"+str(str3)+"-"+str(str4)+"-"+str(str5)
#IMDN_MESSAGE_ID=                        result_str
...
FT_CONTENT_TRANSFER_ENCODING=			LM_CONTENT_TRANSFER_ENCODING
#######################################################################################
#XMl/JSON
...
store_RCS=									3
HTTPTRLCOUNT=								201
TRL_MSG_CONTEXT_IDS=					{"X-RCS-CHAT":5,"X-RCS-FT":6,"X-RCS-CHAT-SESSION":7,"X-RCS-FT-SESSION":8,"X-RCS-CHAT-GSO":9,"X-RCS-FT-GSO":10,"FAXMESSAGE":11,"X-IVR-GREETING":12,"X-CALL-HISTORY":13,"X-RCS-PM":14,"X-RCS-LM":15}
