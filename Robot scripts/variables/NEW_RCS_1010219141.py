...
#################################################################################################
#MESSAGE_CONTEXT
PM_MESSAGE_CONTEXT=						"chat-message"
CHAT_MESSAGE_CONTEXT=					"chat-message"
LM_MESSAGE_CONTEXT=						"standalone-message"
FT_MESSAGE_CONTEXT=						"file-message"
CHAT_SESSION_MESSAGE_CONTEXT=			"session-info-message"
FT_SESSION_MESSAGE_CONTEXT=				"session-info-message"
CALLHISTORY_MESSAGE_CONTEXT=            "X-Call-History"
SESSION_MESSAGE_CONTEXT=				"SIO"
#################################################################################################
CHAT_PARENT_FOLDER_PATH=                str(RCS_PARENT_PATH)
...
FT_PARENT_FOLDER_PATH=                str(RCS_PARENT_PATH)
...
store_RCS=									3
HTTPTRLCOUNT=                               202
TRL_MSG_CONTEXT_ID=                    {"chat-message":5,"X-RCS-FT":6,"X-RCS-CHAT-SESSION":7,"X-RCS-FT-SESSION":8,"X-RCS-CHAT-GSO":9,"X-RCS-FT-GSO":10,"FAXMESSAGE":11,"X-IVR-GREETING":12,"X-CALL-HISTORY":13,"X-RCS-PM":14,"X-RCS-LM":15}
CARD_ID=									0
